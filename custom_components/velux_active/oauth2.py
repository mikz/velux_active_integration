...
from homeassistant.components.velux_active.const import OAUTH2_CLIENT_ID, OAUTH2_CLIENT_SECRET
...
def register_oauth2_implementations(
    ...
    config_flow.VeluxActiveFlowHandler.async_register_implementation(
        hass,
        VeluxActiveOAuth2Implementation(
            hass,
...
class VeluxActiveOAuth2Implementation(config_entry_oauth2_flow.AbstractOAuth2Implementation):
